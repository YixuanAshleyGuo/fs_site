...
class eventForm(forms.Form):
    ...
    exp_type = forms.ChoiceField(choices = EXP_TYPE, widget=forms.Select(attrs={'class':'form-control','id':'exp_type'}))
    ...
    location = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control', 'disabled': 'true', 'id': 'location'}),max_length=255)